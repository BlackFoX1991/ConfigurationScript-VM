...
namespace CFGS_VM.VMCore
{
    public partial class VM
    {
        ...
        /// </summary>
        private static void ApplySliceSet(ref object target, object startObj, object endObj, object value, Instruction instr)
        {
            if (target is string)
            {
                throw new VMException(
        ...
        /// </summary>
        private static void DeleteSingleCollectionElement(object target, object idxObj, Instruction instr, string? variableName)
        {
            if (target is string)
            {
                throw new VMException(
