...
try {
    ...
    Run-ExpectContains -Name "476_protected_static_access_outside_fail" -ScriptArgs @((Edge-Path "_edgecases\476_protected_static_access_outside_fail.cfs")) -Expected "inaccessible member 'ps' in class 'Base': 'protected' access"
    ...
    Run-ExpectContains -Name "478_runtime_alias_private_static_set_fail" -ScriptArgs @((Edge-Path "_edgecases\478_runtime_alias_private_static_set_fail.cfs")) -Expected "inaccessible member 's' in class 'C': 'private' access"
    ...
    Run-ExpectContains -Name "481_reserved_ctor_alias_instance_fail" -ScriptArgs @((Edge-Path "_edgecases\481_reserved_ctor_alias_instance_fail.cfs")) -Expected "class instances are not indexable; use dot access for members"
    Run-ExpectContains -Name "482_reserved_ctor_alias_static_fail" -ScriptArgs @((Edge-Path "_edgecases\482_reserved_ctor_alias_static_fail.cfs")) -Expected "class static members are not indexable; use dot access for static members"
    ...
    Run-ExpectContains -Name "517_instance_assign_unknown_member_runtime_fail" -ScriptArgs @((Edge-Path "_edgecases\517_instance_assign_unknown_member_runtime_fail.cfs")) -Expected "invalid instance member 'missing' in class 'Box'"
    Run-ExpectContains -Name "518_static_assign_unknown_member_runtime_fail" -ScriptArgs @((Edge-Path "_edgecases\518_static_assign_unknown_member_runtime_fail.cfs")) -Expected "unknown static member 'missing' in class 'Box'"
    Run-ExpectContains -Name "519_this_assign_unknown_member_fail" -ScriptArgs @((Edge-Path "_edgecases\519_this_assign_unknown_member_fail.cfs")) -Expected "unknown instance member 'missing' in class 'Box'"
    Run-ExpectContains -Name "520_class_static_assign_unknown_member_fail" -ScriptArgs @((Edge-Path "_edgecases\520_class_static_assign_unknown_member_fail.cfs")) -Expected "unknown static member 'missing' in class 'Box'"
    ...
    Run-ExpectContains -Name "510_invalid_assign_target_fail" -ScriptArgs @((Edge-Path "_edgecases\510_invalid_assign_target_fail.cfs")) -Expected "Invalid lvalue for store."
    Run-ExpectContains -Name "511_invalid_update_target_fail" -ScriptArgs @((Edge-Path "_edgecases\511_invalid_update_target_fail.cfs")) -Expected "invalid lvalue expression"
    ...
    Run-ExpectContains -Name "523_properties_valid" -ScriptArgs @((Edge-Path "_edgecases\523_properties_valid.cfs")) -Expected "EDGE_OK:523_properties_valid"
    Run-ExpectContains -Name "524_property_private_set_runtime_fail" -ScriptArgs @((Edge-Path "_edgecases\524_property_private_set_runtime_fail.cfs")) -Expected "inaccessible setter for instance property 'secret' in class 'Vault': 'private' access"
    Run-ExpectContains -Name "525_property_initializer_missing_set_fail" -ScriptArgs @((Edge-Path "_edgecases\525_property_initializer_missing_set_fail.cfs")) -Expected "property 'value' in class 'Box' has no init or set accessor"
    Run-ExpectContains -Name "526_interface_property_visibility_fail" -ScriptArgs @((Edge-Path "_edgecases\526_interface_property_visibility_fail.cfs")) -Expected "interface property 'token' accessor 'get'"
    Run-ExpectContains -Name "527_property_field_shadowing_fail" -ScriptArgs @((Edge-Path "_edgecases\527_property_field_shadowing_fail.cfs")) -Expected "invalid local binding 'field': reserved backing-field identifier inside property accessors with hidden storage"
    Run-ExpectContains -Name "528_property_field_without_storage_fail" -ScriptArgs @((Edge-Path "_edgecases\528_property_field_without_storage_fail.cfs")) -Expected "invalid backing-field access 'field': current property has no hidden backing storage"
    Run-ExpectContains -Name "529_namespace_merge_across_imports" -ScriptArgs @((Edge-Path "_edgecases\529_namespace_merge_across_imports.cfs")) -Expected "EDGE_OK:529_namespace_merge_across_imports"
    Run-ExpectContains -Name "530_file_scoped_namespace_merge" -ScriptArgs @((Edge-Path "_edgecases\530_file_scoped_namespace_merge.cfs")) -Expected "EDGE_OK:530_file_scoped_namespace_merge"
    Run-ExpectContains -Name "531_file_scoped_namespace_not_first_fail" -ScriptArgs @((Edge-Path "_edgecases\531_file_scoped_namespace_not_first_fail.cfs")) -Expected "file-scoped namespace must be the first declaration after the import header"
    Run-ExpectContains -Name "532_use_namespace_valid" -ScriptArgs @((Edge-Path "_edgecases\532_use_namespace_valid.cfs")) -Expected "EDGE_OK:532_use_namespace_valid"
    ...
    Run-ExpectContains -Name "539_class_bracket_static_member_fail" -ScriptArgs @((Edge-Path "_edgecases\539_class_bracket_static_member_fail.cfs")) -Expected "class static members require dot access"
