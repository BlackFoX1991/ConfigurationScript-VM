...
try {
    ...
    Run-ExpectContains -Name "518_static_assign_unknown_member_runtime_fail" -ScriptArgs @((Edge-Path "_edgecases\518_static_assign_unknown_member_runtime_fail.cfs")) -Expected "invalid static member 'missing' in class 'Box'"
