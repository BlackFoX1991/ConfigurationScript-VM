...
## 24. Weiterfuehrende Dateien

- `README.md` fuer den kompakten Projektueberblick
- `USAGE_NOTES.md` fuer Deploy- und Betriebsnotizen
- `Progress.md` fuer den aktuellen Projektstand
- `Roadmap.md` fuer verbleibende Themen
